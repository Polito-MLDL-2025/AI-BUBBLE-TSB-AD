...
def parse_arguments():
    ...
    parser.add_argument('-f', '--file_list', type=str, default='Datasets/File_List/TSB-AD-M-Eva-filtered.csv')
    parser.add_argument('-S', '--score', type=str, default=f'{BASE_FOLDER}/Scores/Multivariate')
